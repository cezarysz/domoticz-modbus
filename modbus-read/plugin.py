...
#
"""
<plugin key="Modbus" name="Modbus RTU/ASCII/TCP - READ v1.2.1" author="C. Szy / domoticx.nl" version="1.2.0" externallink="" wikilink="https://github.com/DomoticX/domoticz-modbus/">
    <params>
